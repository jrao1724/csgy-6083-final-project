...
for i in range(801):
    ...
    mysql_statement = f"INSERT INTO EnergyConsumption (eventTimestamp, eventLabel, numValue, totalEnergyConsumed, deviceID, priceTimeID) VALUES ('{timestamp}', '{eventLabel}', '{numValue}', {deviceID}, {priceTimeID});".replace('None', 'NULL')
